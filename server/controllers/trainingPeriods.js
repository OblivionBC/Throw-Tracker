...
exports.addTrainingPeriod = asyncHandler(async (req, res) => {
  ...
  Logger.log("Adding with End Date");
  ...
  Logger.log("Adding Training Period for Person " + finalPrsnRk);
});
...
exports.getAllTrainingPeriods = asyncHandler(async (req, res) => {
  ...
  Logger.log(allTrainingPeriods.rows);
...
exports.getTrainingPeriod = asyncHandler(async (req, res) => {
  ...
  Logger.log("Getting Training Period " + trpe_rk);
});
...
exports.endDateMostRecentTrainingPeriod = asyncHandler(async (req, res) => {
  ...
  Logger.log("End Dating Most Recent Training Period for person " + prsn_rk);
  Logger.log(TrainingPeriod.rows);
});
...
exports.updateTrainingPeriod = asyncHandler(async (req, res) => {
  ...
  Logger.log("Updating Training Period " + trpe_rk);
});
