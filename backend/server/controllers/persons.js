...
exports.updatePerson = async (req, res) => {
  try {
    ...
    Logger.error("Error occurred Updating Person:", err.message);
...
exports.deletePerson = async (req, res) => {
  try {
    ...
    Logger.error("Error deleting person:", err.message);
...
exports.getMe = asyncHandler(async (req, res) => {
  ...
  const userData = {
    ...
    first_nm: user.rows[0].prsn_first_nm, // Map to frontend expected field
    last_nm: user.rows[0].prsn_last_nm, // Map to frontend expected field
    prsn_first_nm: user.rows[0].prsn_first_nm, // Keep original for compatibility
    prsn_last_nm: user.rows[0].prsn_last_nm, // Keep original for compatibility
