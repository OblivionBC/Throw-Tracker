...
exports.addProgram = asyncHandler(async (req, res) => {
  ...
  Logger.log("Creating Program for Coach : " + coach_prsn_rk);
...
exports.getAllProgramsForCoach = asyncHandler(async (req, res) => {
  const coach_prsn_rk = req.user.id;
...
exports.getProgramDetails = asyncHandler(async (req, res) => {
...
exports.getProgramsForTrainingPeriod = asyncHandler(async (req, res) => {
